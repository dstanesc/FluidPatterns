...
export class TrackedPropertyTree extends SharedPropertyTree {
    ...
    protected override submitLocalMessage(content: any, localOpMetadata: unknown = undefined): void {
        this["verifyNotClosed"]();
        if (this.isAttached()) {
            // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
            const deltaCon = this["services"]!.deltaConnection;
            deltaCon.submit(content, localOpMetadata);
        }
    }
    ...
    public static pruneAndSave(
        ...
        prop.remoteChanges.forEach((msg)=>console.log(JSON.stringify(msg)));   
